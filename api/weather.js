// GET /api/weather?q=city - 날씨 정보 조회 (API 키 프록시)
...
export default async function handler(req, res) {
  ...
  try {
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${encodeURIComponent(q)}&appid=${apiKey}&units=metric&lang=kr`;
